...
**In-app:** Browse — kind + tier filter, **channel picker** (personalizes ranking by ethos), free-text vibe search (`lo-fi night drive`), Supply kind toggle, Channels verify button. Usage reporter lives on listing + placement pages.
