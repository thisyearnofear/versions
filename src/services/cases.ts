...
// case-state engine (DEFAULT_PLAN, deriveCasePlan, rowToCase, rowToEvent,
// projectStatus, planForStatus, projectedCase) extracted to ./case-state.ts
...
export function createCasesService(): CasesService {
  ...
  // Pure lifecycle projection (rowToCase / rowToEvent / projectStatus /
  // planForStatus / projectedCase) is extracted to ./case-state.ts.
