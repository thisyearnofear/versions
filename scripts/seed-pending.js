// One-off: submit a single unrated submission so the curator queue has something
// to show. The seed script publishes everything, so we need a fresh
// awaiting_curation row to demonstrate the radar.
...
const audio = Buffer.alloc(8000, 0); // 1s of 8kHz silence
